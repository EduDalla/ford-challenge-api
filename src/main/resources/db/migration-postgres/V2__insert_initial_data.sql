...
VALUES
    ...
    ('Bruno Souza', 'bruno.souza@example.com', '11999990002', '22233344455', 'Servicos', 'MEDIO', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
VALUES
    (1, 'TELEFONE', 'Contato para entender queda de uso do servico.', 'Cliente solicitou nova proposta.', CURRENT_TIMESTAMP),
    (1, 'EMAIL', 'Envio de materiais com beneficios do plano atual.', 'Aguardando retorno.', CURRENT_TIMESTAMP),
    (3, 'WHATSAPP', 'Mensagem para agendar reuniao de retencao.', 'Reuniao marcada.', CURRENT_TIMESTAMP);
